...
public:
	...
	// but the rest works
	LPCTSTR Format(TCHAR* pszBuffer, int iBufferLen, const TCHAR* pszFormat) const;
...
private:
	...
	static int FindStr(TCHAR* pszSource, const TCHAR* pszSub, size_t nStart);
	static int ReplaceStr(TCHAR* pszDest, int nDestSize, const TCHAR* pszMask, const TCHAR* pszSource);
...
public:
	...
	// formatting
	TCHAR* Format(TCHAR* pszBuffer, int iBufferLen, const TCHAR* pFormat) const;
#if defined(USE_MFC)
	CString Format(LPCTSTR pFormat) const;
	CString FormatA(LPCTSTR pFormat) const;
